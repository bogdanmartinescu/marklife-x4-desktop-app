  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'src/main/paths.ts',
        'src/main/menu/apply.ts',
        'src/renderer/src/features/commands/use-commands.ts',
        'src/renderer/src/features/commands/use-menu-sync.ts',
        'src/renderer/src/features/editor/use-editor-shortcuts.ts',
